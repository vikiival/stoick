module.exports = class Data1716323008414 {
    name = 'Data1716323008414'

    async up(db) {
        await db.query(`CREATE TABLE "collection_event" ("id" character varying NOT NULL, "block_number" numeric, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "caller" text NOT NULL, "current_owner" text, "interaction" character varying(6) NOT NULL, "meta" text NOT NULL, "collection_id" character varying, CONSTRAINT "PK_5071dfbea812b4caade2ede2139" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "event" ("id" character varying NOT NULL, "block_number" numeric, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "caller" text NOT NULL, "current_owner" text NOT NULL, "interaction" character varying(6) NOT NULL, "meta" text NOT NULL, "nft_id" character varying, CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "nft_entity" ("block_number" numeric, "burned" boolean NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "current_owner" text NOT NULL, "hash" text NOT NULL, "id" character varying NOT NULL, "image" text, "issuer" text NOT NULL, "lewd" boolean NOT NULL, "media" text, "metadata" text, "name" text, "price" numeric, "recipient" text, "royalty" numeric, "sn" text NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "version" integer NOT NULL, "collection_id" character varying, "meta_id" character varying, "token_id" character varying, CONSTRAINT "PK_ed09c6a38c0f0a867d5a7b63f0d" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "collection_entity" ("block_number" numeric, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "current_owner" text NOT NULL, "distribution" integer NOT NULL, "floor" numeric NOT NULL, "hash" text NOT NULL, "highest_sale" numeric NOT NULL, "id" character varying NOT NULL, "image" text, "issuer" text NOT NULL, "max" integer, "media" text, "metadata" text, "name" text, "nft_count" integer NOT NULL, "owner_count" integer NOT NULL, "supply" integer NOT NULL, "base_uri" text, "symbol" text, "type" character varying(7) NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "version" integer NOT NULL, "volume" numeric NOT NULL, "meta_id" character varying, CONSTRAINT "PK_5d44e140c4fcb3d961f9e83405f" PRIMARY KEY ("id"))`)
