...
export const AddCollectionPluginV1Args: Codec<AddCollectionPluginV1Args> =
  struct({
    plugin: ref(() => Plugin),
    initAuthority: option(ref(() => Authority)),
  })
...
export const ApprovePluginAuthorityV1Args: Codec<ApprovePluginAuthorityV1Args> =
  struct({
    pluginType: ref(() => PluginType),
...
export const ApproveCollectionPluginAuthorityV1Args: Codec<
...
export const RemoveCollectionPluginV1Args: Codec<RemoveCollectionPluginV1Args> =
  struct({
    pluginType: ref(() => PluginType),
  })
...
export const RevokePluginAuthorityV1Args: Codec<RevokePluginAuthorityV1Args> =
  struct({
    pluginType: ref(() => PluginType),
  })
...
export const RevokeCollectionPluginAuthorityV1Args: Codec<
...
export const UpdateCollectionPluginV1Args: Codec<UpdateCollectionPluginV1Args> =
  struct({
    plugin: ref(() => Plugin),
  })
